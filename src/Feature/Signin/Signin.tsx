    ...
    <>
      ...
      <div className="flex h-screen bg-gray-900 flex-col justify-center px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          />
          <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-white">وورد به پنل ادمین</h2>
        </div>

        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <Box component={"form"} action="#" className="space-y-6">
            <div className='flex flex-col gap-5 '>
              ...
              <div className="block w-full bg-white rounded-md  px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6">
                ...
                <TextField
                  ...
                  sx={sxStyles}
                  className='block  font-medium text-gray-100' label="ایمیل" variant="standard" />
              </div>
              <div className="block w-full bg-white rounded-md  px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6">
                <TextField
                  autoComplete="off"
                  ...
                  InputProps={inputPropsStyles}
                  sx={sxStyles}
                  className='block  font-medium text-gray-100' label="رمز عبور" variant="standard" />
              </div>
